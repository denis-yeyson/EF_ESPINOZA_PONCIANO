...
public class RegistroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAgregarProducto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (nombre.isEmpty() || marca.isEmpty() || descripcion.isEmpty() || cantidad.isEmpty() || precio.isEmpty()) {
                    Toast.makeText(RegistroActivity.this, "Debe completar todos los campos para registrar", Toast.LENGTH_SHORT).show();
                } else {
        ...
        btnListarProductoNuevo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(RegistroActivity.this, ListaActivity.class));
            }
        });
    }
    public void registrarProducto(String nombre, String marca, String descripcion, String cantidad, String precio) {
        ...
        String key = base_de_datos.child("Producto").push().getKey();

        base_de_datos.child("Producto").child(key).setValue(map).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task4) {
                if (task4.isSuccessful()) {
                    Toast.makeText(RegistroActivity.this, "Producto Agregado correctamente", Toast.LENGTH_SHORT).show();
                    finish();
                    startActivity(new Intent(RegistroActivity.this, ListaActivity.class));
                } else {
                    Toast.makeText(RegistroActivity.this, "No se pudo guardar los datos en la Base de Datos", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
